...
export class SaveManager {
    ...
    loadInitialState() {
        ...
        try {
            ...
            return {
                ...
                currentChapter: parsed.currentChapter || defaultState.currentChapter,
                mapUnlocked: parsed.mapUnlocked === true,
    ...
    saveState(state) {
        ...
        const dataToSave = {
            ...
            currentChapter: state.currentChapter || 'ch1',
            mapUnlocked: state.mapUnlocked === true,
